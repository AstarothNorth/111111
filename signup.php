                ...
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-4">
                        ...
                        <form method="post" action="user_registration_script.php">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="password" placeholder="Пароль (минимум 6 символов)" required="true" pattern=".{6,}">
                            </div>
                            <div class="form-group"> 
                                <input type="tel" class="form-control" name="contact" placeholder="Телефон" required="true">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="city" placeholder="Город" required="true">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="Adress" placeholder="Адрес" required="true">
                            </div>
                            <div class="form-group">
